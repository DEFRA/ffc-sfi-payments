...
const allocateToLedgers = (paymentRequest, unsettled) => {
  if (unsettled.AR.value > 0 && paymentRequest.ledger === 'AP') {
    return updatePaymentRequest(paymentRequest, unsettled.AR.value, 'AR')
  }
  if (unsettled.AP.value > 0 && paymentRequest.ledger === 'AR') {
    return updatePaymentRequest(paymentRequest, unsettled.AP.value, 'AP')
  }
}
